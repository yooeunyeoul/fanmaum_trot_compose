...
@Composable
fun VerticalDialogInvitationComplete(
    ...
    val composition by rememberLottieComposition(spec = LottieCompositionSpec.RawRes(R.raw.popup_confetti01))
        ...
        Box(
            ...
            AsyncImage(
                model = ImageRequest.Builder(LocalContext.current)
                    .data(R.drawable.popup_invitation)
